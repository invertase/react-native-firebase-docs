...
- 1.1) Clone the starter kit repo:
...
- 1.3) Install packages with your package manager of choice - i.e run `yarn` or `npm install`
...
- 3.2) **[iOS]** Place this file in the `ios/` directory of your project.
  - Once added to the directory, add the file to your Xcode project using 'File > Add Files to "[YOUR APP NAME]"…' and select the plist file.
...
## Links
  ...
  - [Starter Kit - GitHub](https://github.com/invertase/react-native-firebase-starter)
